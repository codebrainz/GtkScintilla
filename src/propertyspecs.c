	...
	pspec = g_param_spec_boolean("undo-collection", 
			"Undo collection", 
			"Get/set the undo-collection property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("buffered-draw", 
			"Buffered draw", 
			"Get/set the buffered-draw property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("tab-indents", 
			"Tab indents", 
			"Get/set the tab-indents property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("mouse-down-captures", 
			"Mouse down captures", 
			"Get/set the mouse-down-captures property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("hotspot-active-underline", 
			...
			"Get/set the hotspot-active-underline property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("hotspot-single-line", 
			"Hotspot single line", 
			"Get/set the hotspot-single-line property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("paste-convert-endings", 
			...
			"Get/set the paste-convert-endings property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("additional-carets-blink", 
			...
			"Get/set the additional-carets-blink property", FALSE, 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("additional-carets-visible", 
			...
			"Get/set the additional-carets-visible property", FALSE, 
			G_PARAM_READWRITE);
