	...
	pspec = g_param_spec_boolean("undo-collection", 
			"Undo collection", 
			"Get/set the undo-collection property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("buffered-draw", 
			"Buffered draw", 
			"Get/set the buffered-draw property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("sel-eol-filled", 
			"Sel eol filled", 
			"Get/set the sel-eol-filled property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("caret-line-visible", 
			"Caret line visible", 
			"Get/set the caret-line-visible property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_int("tarstart", 
			"Tarstart", 
			"Get/set the tarstart property", 
			G_MININT, G_MAXINT, 0,  
			G_PARAM_READWRITE);
	g_object_class_install_property(object_class, PROP_TARSTART, pspec);
	pspec = g_param_spec_int("tarend", 
			"Tarend", 
			"Get/set the tarend property", 
			G_MININT, G_MAXINT, 0,  
			G_PARAM_READWRITE);
	g_object_class_install_property(object_class, PROP_TAREND, pspec);
	...
	pspec = g_param_spec_boolean("mouse-down-captures", 
			"Mouse down captures", 
			"Get/set the mouse-down-captures property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("hotspot-active-underline", 
			...
			"Get/set the hotspot-active-underline property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("hotspot-single-line", 
			"Hotspot single line", 
			"Get/set the hotspot-single-line property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("paste-convert-endings", 
			...
			"Get/set the paste-convert-endings property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("keys-unicode", 
			"Keys unicode", 
			"Get/set the keys-unicode property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("multiple-selection", 
			"Multiple selection", 
			"Get/set the multiple-selection property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("additional-selection-typing", 
			...
			"Get/set the additional-selection-typing property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("additional-carets-blink", 
			...
			"Get/set the additional-carets-blink property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_boolean("additional-carets-visible", 
			...
			"Get/set the additional-carets-visible property", 
			G_PARAM_READWRITE);
	...
	pspec = g_param_spec_static_string("whitespace-chars", 
			"Whitespace chars", 
			"Set the whitespace-chars property", 
			G_PARAM_WRITABLE);
	g_object_class_install_property(object_class, PROP_WHITESPACE_CHARS, pspec);
	pspec = g_param_spec_int("length-for-encode", 
			"Length for encode", 
			"Set the length-for-encode property", 
			G_MININT, G_MAXINT, 0,  
			G_PARAM_WRITABLE);
	g_object_class_install_property(object_class, PROP_LENGTH_FOR_ENCODE, pspec);
	...
	pspec = g_param_spec_static_string("lexer-language", 
			"Lexer language", 
			"Set the lexer-language property", 
			G_PARAM_WRITABLE);
